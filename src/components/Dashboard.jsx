    ...
    <div className="min-h-screen bg-slate-50 dark:bg-[#0B1120] transition-colors duration-500 p-8 relative overflow-hidden">
      ...
      <div className="max-w-[1200px] mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {/* Lista de Proyectos */}
          {loading ? (
            <div className="text-slate-500 dark:text-slate-400 animate-pulse col-span-2 font-bold p-8">Cargando tus espacios...</div>
          ) : (
            projects.map(project => (
              ...
              >
                ...
                {/* Botón Flotante de Borrar (Aparece en Hover) */}
                ...
                <div>
                  <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white mb-4 shadow-sm relative">
